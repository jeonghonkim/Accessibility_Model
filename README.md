...
* *_Directions* &nbsp;|&nbsp; The directions are the outcomes from solving Closest-Facility analysis with '_AllStreets' as incidents and '_Markets_Original' as facilities.
* *_Markets_Original* &nbsp;|&nbsp; You can select the latitude field in the entered csv file. 
* *_Markets_Summary* &nbsp;|&nbsp; You can select the longitude field in the entered csv file.
* *_Routes_Original* &nbsp;|&nbsp; You can enter the mile-distance from market locations as you wish.
* *_Routes_TrafficTurns* &nbsp;|&nbsp; You can enter exact time will generate drive times. The currnet time will be applied if you select the clock symbol.
